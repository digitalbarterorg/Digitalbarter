...
#if defined(NDEBUG)
# error "Barter cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x7a646e5b543b4f206b718ce01c369e92932ad0c8cb9747fe0acda4d714332756");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Barter: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Barter Signed Message:\n";
...
{
    // Barter: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Barter: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Barter: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1501924511, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e94163945e7543c799111df70877fd731b25649ab7f0efa28c3ab99db01e852a923be185f672fd7d55dafeb46831075e5ce3dea73319a43add4279b7e6f65502") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1501924511;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1156134;
        ...
        assert(block.hashMerkleRoot == uint256("0x6dcccd34cedb749eb846348efb1b7a9f7a9cc94d7820f7b0fe1e163e1b6256a7"));
...
unsigned char pchMessageStart[4] = { 0xf2, 0x32, 0xad, 0x14 }; // Barter: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BarterMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BarterMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BarterMiner(CWallet *pwallet)
{
    printf("BarterMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("barter-miner");
    ...
    try { loop {
        ...
        printf("Running BarterMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BarterMiner, pwallet));
}
